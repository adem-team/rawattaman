...
use api\modules\master\models\JadwalSearch;
...
{	
	 ...
	 */
    public $modelClass = 'api\modules\master\models\JadwalSearch';
	public $serializer = [
		'class' => 'yii\rest\Serializer',
		'collectionEnvelope' => 'jadwalkunjng',
	];
        ...
        return [
            'index' => [
                ...
                'prepareDataProvider' => function () {					
					$param=["JadwalSearch"=>Yii::$app->request->queryParams];
					//return $param;
