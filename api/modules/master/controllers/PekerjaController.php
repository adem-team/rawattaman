...
use api\modules\master\models\DataPekerjaSearch;
 ...
 */
class PekerjaController extends ActiveController
{	
	/**
	  * Source Database declaration 
	 */
    public $modelClass = 'api\modules\master\models\DataPekerja';
	public $serializer = [
		'class' => 'yii\rest\Serializer',
		'collectionEnvelope' => 'pekerja',
	];
        ...
        return [
            'index' => [
                ...
                'prepareDataProvider' => function () {					
					$param=["DataPekerjaSearch"=>Yii::$app->request->queryParams];
					//return $param;
                    $searchModel = new DataPekerjaSearch();
