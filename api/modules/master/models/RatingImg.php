...
class RatingImg extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            [['IMAGE_64'], 'string'],
            [['STATUS'], 'integer'],
            [['CREATE_AT', 'UPDATE_AT','KETERANGAN'], 'safe'],
	...
	{
		return [			
			'RETING_ID'=>function($model){
				return $model->RETING_ID;
			},
			...
			'IMAGE_64'=>function($model){
				return $model->IMAGE_64!=''?$model->IMAGE_64:$this->noimage;
			}
		];
	}
