...
use kartik\widgets\ActiveField;
	...
	$dvProduk=DetailView::widget([
		...
		'hover'=>true,
		'panel'=>[
			'heading'=>'<div style="float:left;margin-right:10px" class="fa fa-1x fa-list-alt"></div><div><h6 class="modal-title"><b> View/Edit Produk</b></h6></div>',
